...
func JobMatchTemplate() *PromptTemplate {
  ...
  "feedback": "Good match overall. You have the certifications and classroom experience needed. Your lack of formal leadership experience is a weakness - mentoring isn't the same as managing. Budget management skills are completely absent from your profile, which is concerning for a coordinator role."
		...
		Constraints: []string{
			...
			"FRESH EVALUATION ONLY: Ignore any previous match scores - evaluate based solely on CURRENT profile content",
			"Each match analysis is independent - users improve profiles over time, don't penalize past gaps",
			...
			"SIMILAR SKILLS BONUS: Award modest score increases (5-10 points) for related technologies (e.g., Python/Java, React/Vue, AWS/Azure)",
			...
			"INDUSTRY EXPERIENCE: Award 5-10 points for same industry experience, 3-5 points for related industries",
			"SOFT SKILLS RECOGNITION: Leadership, communication, problem-solving add 3-5 points when demonstrated with examples",
